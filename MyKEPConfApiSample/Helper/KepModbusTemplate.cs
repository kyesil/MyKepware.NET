...
{
   public  class KepModbusTemplate:KepTemplate
    {
        public override string getChJson(string name,string port)
        {
        ...
        public override string getDevJson(string name,string host, string port)
        {
        ...
        public override string getTagsJson(List<Tuple<string,string,int>> tags)
        {
            string result = "";
